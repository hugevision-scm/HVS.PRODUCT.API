...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API260ULF
...
##  Request
 ...
 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**uploadphysicalinventory**
...
|&nbsp; &nbsp; &nbsp; &nbsp; qtyCount|bigdecimal|16,6|✓|盘点数量。必须大于0。|
...
```
{
    ...
    "requestId": "API260UL-0000-0000-0000-000000000001",
    "requestResult": "1",                                                              /*1: 成功*/
    "responseTime": "2021-11-30 12:00:00",
    "errorMsg": "处理成功",
    "targetRequestId": "API260UL-0000-0000-0000-000000000001",

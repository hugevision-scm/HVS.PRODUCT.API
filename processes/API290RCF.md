...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API290RCF
...
##  Request
 ...
 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**docaction_rc**
...
```
{
    ...
    "requestId": "API290RC-0000-0000-0000-000000000001",
    "requestResult": "1",                                                              /*1: 成功*/
    "responseTime": "2021-11-30 12:00:00",
    "errorMsg": "处理成功",
    "targetRequestId": "API290RC-0000-0000-0000-000000000001",

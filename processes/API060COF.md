...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API060COF
...
**系统异常结后，还得调用API060NNF查询处理结果。**

##  Request

 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**importdeemedsalesorder_co_f**
...
|&nbsp; &nbsp; doctype_Name|string|60||单据类型的名称。<br>可填写如下单据类型<br>&nbsp; 实物领用|
...
|&nbsp; &nbsp; deliveryViaRule_Text|string|60||发货方式的名称。不填写时取得收货地址的发货方式。<br>可填写如下发货方式<br>&nbsp; 配送<br>&nbsp; 自提|
...
```
{
    ...
    "requestId": "API060CO-0000-0000-0000-000000000001",
    "requestResult": "1",                                                              /*1: 成功*/
    "responseTime": "2021-11-30 12:00:00",
    "errorMsg": "处理成功",
    "targetRequestId": "API060CO-0000-0000-0000-000000000001",

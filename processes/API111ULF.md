...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API111ULF
...
##  Request
 ...
 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**uploadshipmentconfirm**
...
|&nbsp; &nbsp; confirmType_Text|date|10|✓|确认类型。<br>可填写确认类型如下<br>&nbsp; 出库确认<br>&nbsp; 签收确认。<br>主体公司要出库确认和签收确认时必填。|
...
|&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; dateReceipt|date|10||入库日期。格式为yyyy-MM-dd。不填写时从库存自动匹配。|
...
```
{
    ...
    "requestId": "API111UL-0000-0000-0000-000000000001",
    "requestResult": "1",                                                              /*1: 成功*/
    "responseTime": "2021-11-30 12:00:00",
    "errorMsg": "处理成功",
    "targetRequestId": "API111UL-0000-0000-0000-000000000001",

...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API16BFSF

---

## API概述

导入**移库单移入完成**，导入后移库单的物流回执状态(移入)为**完成**，并移库单的单据操作完成。
...
|&nbsp; &nbsp; lineList|list|||单据行列表。行列表不填写则移入确认数量=移库单的数量。|
|&nbsp; &nbsp; &nbsp; &nbsp; line|string|20||移库单行的行号|
|&nbsp; &nbsp; &nbsp; &nbsp; qtyReceipt|bigdecimal|16,6|条件|移入确认数量。必须大于等于0。行列表填写时必填。|
|&nbsp; &nbsp; &nbsp; &nbsp; lineDescriptionTo|string|255||行的附注(移入)|

JSON格式样例(有条件)
```
{
    "requestId": "API16BFS-0000-0000-0000-000000000001",
...
```
{
    ...
    "errorMsg": "处理成功",
    "targetRequestId": "API16BFS-0000-0000-0000-000000000001",

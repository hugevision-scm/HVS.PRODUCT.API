...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API180COF
...
**系统异常结后，还得调用API180NNF查询处理结果。**

##  Request

 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**importdealerrequisition_co_f**

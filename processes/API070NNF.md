...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API070NNF
...
##  Request
 ...
 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**inquiryreceipt_co**
...
```
{
    "requestId": "API070NN-0000-0000-0000-000000000001",
    "requestTime": "2021-11-30 12:30:00",
    "targetRequestId": "API070CO-0000-0000-0000-000000000001"
}
```
...
* 处理成功时返回如下JSON数据（与API070COF的Response一样格式）
...
|&nbsp; &nbsp; docStatus|string|2||单据状态。单据处理结果为**成功**时设定。<br>&nbsp; IP:开放<br>&nbsp; CO:完成|
|&nbsp; &nbsp; lineList|list||✓|单据行列表|
...
* Request Body的JSON格式错误时返回如下JSON数据（与API070COF的Response一样格式）

...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API050COB
...
**此API调用后，还得调用API050NNF查询处理结果。**

##  Request

 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**importsalesreturn_co_b**
...
```
{
    "requestId": "API050CO-0000-0000-0000-000000000001",
    "requestResult": "1",

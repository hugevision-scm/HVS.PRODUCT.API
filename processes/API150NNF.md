...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API150NNF
...
##  Request
 ...
 ```POAC```  https://*{ HVS的URL }*/api/v1/processes/**inquiryinventoryasichange_co**
...
```
{
    "requestId": "API150NN-0000-0000-0000-000000000001",
...
* 处理成功时返回如下JSON数据（与API150COF的Response一样格式）
...
* Request Body的JSON格式错误时返回如下JSON数据（与API150COF的Response一样格式）

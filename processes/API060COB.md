...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API060COB
...
**此API调用后，还得调用API060NNF查询处理结果。**

##  Request

 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**importdeemedsalesorder_co_b**

...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API150COB
...
**此API调用后，还得调用API150NNF查询处理结果。**

##  Request

 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**importinventoryasichange_co_b**
...
|&nbsp; &nbsp; &nbsp; &nbsp; lotTo|string|40|条件|变更后批号。批号管理产品时必填。|
|&nbsp; &nbsp; &nbsp; &nbsp; dateProductionTo|date|10|条件|变更后生产日期。保质期管理产品时必填。格式为yyyy-MM-dd。|
|&nbsp; &nbsp; &nbsp; &nbsp; invStatusTo_Name|string|60|条件|变更后库存状态的名称。库存状态管理产品时必填。<br>可填写如下库存状态。<br>&nbsp; 正常<br>&nbsp; 冻结<br>&nbsp; 破损<br>&nbsp; 待定|
|&nbsp; &nbsp; &nbsp; &nbsp; lineDescription|string|255||单据行的附注|
|&nbsp; &nbsp; &nbsp; &nbsp; movementQty|bigdecimal|16,6|✓|变更数量。必须大于0。|

...
##### [文档首页](../index.md)>[HugeVision-SCM API开发手册向导页](../api.md)>API050NNF
...
##  Request
 ...
 ```POST```  https://*{ HVS的URL }*/api/v1/processes/**inquirysalesreturn_co**
...
```
{
    "requestId": "API050NN-0000-0000-0000-000000000001",
    "requestTime": "2021-11-30 12:30:00",
    "targetRequestId": "API050CO-0000-0000-0000-000000000001"
}
```
...
* 处理成功时返回如下JSON数据（与API050COF的Response一样格式）
...
* Request Body的JSON格式错误时返回如下JSON数据（与API050COF的Response一样格式）

...
|API070COF|创建业务数据|同步|创建收货单|[API070COF](processes/API070COF.md)
|API070COB|创建业务数据|异步|创建收货单|[API070COB](processes/API070COB.md)
|API070NNF|查询异步处理结果|同步|查询收货单的异步处理结果|[API070NNF](processes/API070NNF.md)
...
|API140COF|创建业务数据|同步|创建移库单|[API140COF](processes/API140COF.md)
|API140COB|创建业务数据|异步|创建移库单|[API140COB](processes/API140COB.md)
|API140NNF|查询异步处理结果|同步|查询移库单的异步处理结果|[API140NNF](processes/API140NNF.md)
|API14APDF|查询业务数据|同步|查询移出待处理移库单信息|[API14APDF](processes/API14APDF.md)
|API14BPDF|查询业务数据|同步|查询移入待处理移库单信息|[API14BPDF](processes/API14BPDF.md)
|API150COF|创建业务数据|同步|创建属性变更单|[API150COF](processes/API150COF.md)
|API150COB|创建业务数据|异步|创建属性变更单|[API150COB](processes/API150COB.md)
